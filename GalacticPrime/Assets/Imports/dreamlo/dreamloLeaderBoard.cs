...
public class dreamloLeaderBoard : MonoBehaviour {
    ...
    public void SelectServer(int server) {
        if (server == 1) {
            privateCode = "1fBMVo3VF0enQP31tuvqzw0h1J5ZAD_0649YyvAqgByQ";
            publicCode = "5cd13e523ebb39187028ec41";
        }
        else if (server == 2) {
            privateCode = "xZVg2EAGJ0q5aVxc6qub0wRp8OOVfO2kijTF5WVcB13g";
            publicCode = "5cd156143ebb39187029678f";
        }
    }
